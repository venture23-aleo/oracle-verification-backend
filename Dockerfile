...
&&  apt update \
&&  wget -q https://github.com/edgelesssys/ego/releases/download/v1.7.2/ego_1.7.2_amd64_ubuntu-20.04.deb \
&&  apt install -y ./ego_1.7.2_amd64_ubuntu-20.04.deb libsgx-dcap-default-qpl
